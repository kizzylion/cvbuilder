...
export default function TemplatePaper() {
  return (
    <div
      id="previewPaper"
      className="grid grid-cols-[1fr_3fr] leading-normal mx-auto bg-indigo-50"
    >
      <div
        id="paperAside"
      ...
      >
        <div id="summary" className=" mb-4 text-xs">
          <p>
            ...
            temporibus in, pariatur dignissimos error perspiciatis amet labore
            officia, fugit quos doloribus libero laborum explicabo! Fugit qui
            itaque autem eius!
          </p>
        </div>
        <div id="work" className="pb-3">
          ...
          <div className="flex flex-col text-xs gap-3">
            <p>
              ...
              labore officia, fugit quos doloribus libero la
            </p>
